...
const LineSidebar = ({
  items = ['Documentation', 'Components', 'Templates', 'Pricing'],
  accentColor = '#0ABDC6',
  textColor = '#8A8A93',
  markerColor = '#55555A',
  showIndex = true,
  ...
  return (
    <nav
      className={`line-sidebar${showMarker ? ' line-sidebar--markers' : ''}${scaleTick ? ' line-sidebar--scale-tick' : ''}${isHorizontal ? ' line-sidebar--horizontal' : ''}${className ? ` ${className}` : ''}`}
      style={{
