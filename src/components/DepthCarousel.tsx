...
const normalizeItem = (it: string | DepthCarouselItem) => (typeof it === 'string' ? { image: it, alt: '' } : it);
...
interface DepthCarouselProps {
  ...
  onChange?: (idx: number, item: DepthCarouselItem) => void;
