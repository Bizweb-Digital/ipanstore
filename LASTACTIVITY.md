...
- **Status**: commit `9d75cb3` sudah dibuat, dipush ke `origin/main`, dipull di server, dan frontend dideploy. Asset hashed live `assets/logo-DpS2a02-.png` HTTP 200 dengan pixel sudut `[13, 22, 37, 255]`. Thumbnail Google masih dapat menampilkan cache lama sampai recrawl selesai.
...
- **Background logo publik**: aset logo live sudah memakai navy `#0D1625` agar tidak dirender putih oleh Google; thumbnail Google perlu recrawl.
